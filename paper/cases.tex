...
\Cref{tab:prevalence:rates:broken} (Appendix) for a breakdown of censorship
...
bridge counterparts, see \Cref{tab:prevalence:rates:broken} (Appendix) for a
...
\Cref{sec:infrastructure:domains}, China has a high $\nabla_{net}$ which
