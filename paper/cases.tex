...
~72\% of all blocked queries. This coupled with findings in \Cref{Characteristics of {\tt A/AAAA} 
...
\texttt{A} record but not \texttt{AAAA}. As established in \Cref{Characteristics of {\tt A/AAAA},
