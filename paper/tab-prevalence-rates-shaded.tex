\begin{table}[t]
  ...
  %
  The global medians for each column weighs the contribution of each country
  equally, rather than weighted by the number of resolvers used in tests.
  Countries are grouped together by their distance from this median.
  }
