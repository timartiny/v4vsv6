...
summarize the base rate of censorship (\Cref{sec:prevalence:rates}) and the
domains being censored in each country (\Cref{sec:prevalence:domains}).

\subsection{Base rates of DNS censorship} \label{sec:prevalence:rates}
\input{tab-prevalence-rates-shaded.tex}

A summary of the base rates observed in each of our four {\tt A/AAAA}-IPv4/IPv6
combinations is illustrated in \Cref{tab:prevalence:rates}. 
