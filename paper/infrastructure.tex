...
examine distributions similar to \Cref{sec:resources:country} this time
...
%
We again use a two-sample $t$-test to verify statistical significance of any
observed differences between the two groups for each country and apply a \Sidak
...
infrastructural gap between DNS queries over IPv4 and IPv6. We provide a general
