...
We use an approach similar to the one defined in \Cref{sec:resources:domains} for identifying
...
(as described in \Cref{sec:resources:domains}) to these ratios. This gives us all domains
