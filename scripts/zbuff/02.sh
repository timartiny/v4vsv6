...
date
time -p /home/timartiny/v6censorship/probe-dns/probe -domain v6.tlsfingerprint.io -source-ip 192.12.240.41 -workers 1000 -prefix < ${OUTPUTFOLDER}/${DATESTR}-zmap.csv > ${OUTPUTFOLDER}/${DATESTR}-v4.probe.out
date 
